...
from src.raw.xbrl_company_facts.config import BULK_ZIP_URL, JSON_CACHE_DIR
...
def fetch_bulk_company_facts(
    ...
    if not zip_path.exists():
        _download_bulk_zip(zip_path, user_agent)
...
def _download_bulk_zip(zip_path: Path, user_agent: str) -> None:
