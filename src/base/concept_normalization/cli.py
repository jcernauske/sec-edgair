"""CLI for concept normalization: normalize, status, approve, reject, coverage.

Usage:
    python -m src.base.concept_normalization.cli normalize
    python -m src.base.concept_normalization.cli status
    python -m src.base.concept_normalization.cli approve
    python -m src.base.concept_normalization.cli approve TN-0001 TN-0002
    python -m src.base.concept_normalization.cli reject TN-0042 --reason "Wrong mapping"
    python -m src.base.concept_normalization.cli coverage
"""
...
def cmd_normalize(args: argparse.Namespace) -> None:
    ...
    if gate["gate_action"] == "stop":
        ...
        print("  python -m src.base.concept_normalization.cli status")
        print("  python -m src.base.concept_normalization.cli approve")
    else:
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        prog="concept-normalization",
        description="Concept normalization CLI for SEC EDGAIR",
    )
