...
FINANCIAL_FACTS_SCHEMA = Schema(
    ...
    NestedField(field_id=7, name="business_term_id", field_type=StringType(), required=False),
    NestedField(field_id=8, name="business_term", field_type=StringType(), required=False),
