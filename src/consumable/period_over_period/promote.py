...
Same pattern as financial_ratios promote: get_catalog, get_or_create_table,
...
def promote_period_over_period(
    ...
    *,
    ...
    """
    run_id = emit_start(
        job_name="consumable.period_over_period",
        input_tables=["base.conformed_facts"],
        output_table="consumable.period_over_period",
        producer="src/consumable/period_over_period/promote.py",
    )
    ...
    try:
        ...
        if not records:
            emit_complete(
                run_id=run_id, job_name="consumable.period_over_period",
                output_table="consumable.period_over_period",
                producer="src/consumable/period_over_period/promote.py",
        ...
        table = get_or_create_table(catalog, NAMESPACE, TABLE_NAME, PERIOD_OVER_PERIOD_SCHEMA)
