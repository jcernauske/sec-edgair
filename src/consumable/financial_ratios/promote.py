...
def promote_financial_ratios(
    ...
    *,
    ...
    """
    run_id = emit_start(
        job_name="consumable.financial_ratios",
        input_tables=["base.conformed_facts"],
        output_table="consumable.financial_ratios",
        producer="src/consumable/financial_ratios/promote.py",
    )
    ...
    try:
        ...
        if not records:
            emit_complete(
                run_id=run_id, job_name="consumable.financial_ratios",
                output_table="consumable.financial_ratios",
                producer="src/consumable/financial_ratios/promote.py",
