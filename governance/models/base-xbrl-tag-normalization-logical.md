...
| concept | Text | No | Raw XBRL concept name (e.g., "Revenues") | — |
| canonical_cde | Text | Yes | Mapped CDE name (null for unmapped) | — |
| cde_id | Identifier | Yes | CDE catalog reference (null for unmapped) | CDE-007..CDE-031 |
| financial_statement | Text (enum) | No | Statement classification | — |
| category | Text | No | Subcategory within statement | — |
| tier | Number (1-3) | No | Match quality tier | — |
| confidence | Number (0-1) | No | Match confidence score | — |
...
| Attribute | Domain | Nullable | Description | CDE Reference |
|-----------|--------|----------|-------------|---------------|
| cde_id | Identifier | No | CDE-007 through CDE-031 | Self-referencing |
